          ...
          >
            <g data-name="Layer_1">
              <g>
                ...
                <polygon points="120.42 1.95 125.12 1.95 125.12 21.41 120.42 21.41 120.42 22.88 131.46 22.88 131.46 21.41 126.75 21.41 126.75 1.95 131.46 1.95 131.46 .48 120.42 .48 120.42 1.95" />
                <path d="M148.61,15.04c1.69-.49,2.98-1.34,3.89-2.54.91-1.21,1.36-2.69,1.36-4.46,0-2.37-.8-4.22-2.4-5.55-1.6-1.33-3.81-2-6.62-2h-8.03v22.4h1.63v-7.33h6.4c.66,0,1.39-.05,2.18-.16l5.34,7.49h1.86l-5.6-7.84ZM144.83,14.11h-6.4V1.95h6.4c2.39,0,4.21.53,5.47,1.58,1.26,1.06,1.89,2.56,1.89,4.5s-.63,3.44-1.89,4.5c-1.26,1.06-3.08,1.58-5.47,1.58Z" />
              </g>
            </g>
          </svg>
        ) : (
